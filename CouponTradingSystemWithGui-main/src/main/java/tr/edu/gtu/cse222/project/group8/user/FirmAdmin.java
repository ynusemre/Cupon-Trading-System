...
public class FirmAdmin {
    ...
    public Coupon addCoupon(String couponName, String expireDate, int stock) {
        if(couponName == null || expireDate == null) throw new NullPointerException();
        if(stock < 0) throw new ArithmeticException();

        return(this.firm.addNewCoupon(couponName, expireDate, stock));
    }

    public boolean deleteCoupon(Coupon coupon) {
        return this.firm.removeCoupon(coupon);
    }
